...
```tsx
<EditableHeading id="with-placeholder" ariaLabel="Editable heading with placeholder" value="Clear heading to see placeholder" placeholder="Enter your heading here..." />
```
