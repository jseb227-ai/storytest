...
export class IconMetadataService {
    static UNPKG_URL = "https://unpkg.com/@vibe/icons@latest/dist/iconsMetaData.js";
    static cachedIconMetadata = null;
    static async getIconMetadata() {
        ...
        try {
            ...
            throw new Error("Unable to fetch icon metadata from remote sources. Please check your internet connection and try again.");
        }
    }
    ...
    static parseJavaScriptModule(jsCode) {
