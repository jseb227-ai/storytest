...
const ComponentNameParamsSchema = z.object({
    componentName: z
        .string()
        .optional()
        .describe("Optional. The name of the component to get examples for (e.g., Button, TextField). If omitted, returns examples for all components.")
});
export const getVibeComponentExamples = {
    name: "get-vibe-component-examples",
    description: "Get React usage examples for Vibe components. Returns implementation examples and patterns for specific components or all components if none specified.",
