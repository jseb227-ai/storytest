...
export const listVibePublicComponentsTool = {
    name: "list-vibe-public-components",
    description: "Get a list of all public @vibe/core & @vibe/core/next components names. Use this tool to get the names of components to use in the get-vibe-component-metadata tool.",
    inputSchema: {},
    execute: async () => {
        try {
