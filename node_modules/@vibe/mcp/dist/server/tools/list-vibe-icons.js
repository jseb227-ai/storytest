...
export const listVibeIconsTool = {
    name: "list-vibe-icons",
    description: "Get a list of all available Vibe icons from the @vibe/icons package. Supports optional filtering by text query, category, or tags. Returns icon names, descriptions, categories, and tags, with optional usage examples.",
    ...
    execute: async (input) => {
        ...
        try {
            ...
            if (query) {
                ...
                filteredIcons = filteredIcons.filter(icon => icon.name.toLowerCase().includes(searchTerm) ||
