...
export const getVibeComponentAccessibility = {
    name: "get-vibe-component-accessibility",
    description: "Get accessibility requirements and guidelines for Vibe components. Returns structured accessibility information extracted from component documentation.",
    ...
    execute: async (input) => {
        ...
        try {
            ...
            const accessibilityFilePath = path.resolve(__dirname, "../../../dist/generated/accessibility/", `${componentName}.md`);
