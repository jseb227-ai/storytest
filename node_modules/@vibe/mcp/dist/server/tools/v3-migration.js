...
export const v3MigrationTool = {
    name: "v3-migration",
    description: "Analyzes a project for Vibe 2 to Vibe 3 migration requirements based on the official migration guide. Generates migration commands using tsx and jsx file extensions.",
...
function getMigrationInstructions(projectInfo) {
    return {
        overview: {
            ...
            steps: [
                {
                    ...
                    description: "Use this migration tool with 'detailed' analysis type to understand the scope of changes needed",
                    details: [
                ...
                },
                {
                    ...
                    important: "Do NOT proceed to step 3 until this completes successfully and you verify the packages are installed"
                },
                {
                    step: 3,
                    ...
                    description: "This automated script will handle most import and component transformations. The -y flag skips git confirmation since this tool already manages the process.",
                ...
                },
                {
                    ...
                    important: "🎉 Migration to Vibe 3 is now complete! Your application should be running with all the latest improvements."
                }
            ]
        }
    };
...
async function analyzeImports(projectPath) {
    const importIssues = {
        oldCSSImports: [],
        oldIconImports: [],
...
async function analyzeComponentUsage(projectPath) {
...
function generateRecommendations(analysis, projectInfo) {
    ...
    if (analysis.componentUsage) {
        ...
        Object.entries(usage.removedComponents || {}).forEach(([component, files]) => {
            recommendations.push({
        ...
        Object.entries(usage.breakingChangeComponents || {}).forEach(([component, files]) => {
            recommendations.push({
    ...
    recommendations.push({
        ...
        command: `npx @vibe/codemod -m v3 --target "${projectInfo.targetDirectory}" --extensions tsx jsx -y`,
        details: "This will handle most of the automated transformations. The -y flag auto-confirms to proceed with git changes.",
...
function getComponentReplacement(component) {
    const replacements = {
...
function getBreakingChangeDetails(component) {
    const details = {
