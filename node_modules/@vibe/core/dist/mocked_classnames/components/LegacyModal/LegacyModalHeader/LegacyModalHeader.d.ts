...
declare const LegacyModalHeader: ({ className, title, children, titleClassName, description, descriptionClassName, icon, closeModal, iconSize, iconClassName, closeButtonAriaLabel, id, "data-testid": dataTestId }: LegacyModalHeaderProps) => React.JSX.Element;
