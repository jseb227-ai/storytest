 ...
 */
export default function useClickableProps({ onClick, onMouseDown, onMouseEnter, onMouseLeave, disabled, id, "data-testid": dataTestId, role, tabIndex, ariaLabel, ariaHidden, ariaHasPopup, ariaExpanded }: ClickableProps, ref: React.ForwardedRef<HTMLElement>): {
